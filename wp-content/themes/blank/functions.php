...
function blank_scripts() {
	...
	wp_enqueue_script('jquery', get_theme_file_uri('assets/js/vendor/jquery-1.9.1.min.js'), NULL, '1.0', true);
	wp_enqueue_script('plugins-js', get_theme_file_uri('assets/js/plugins.js'), NULL, '1.0', true);
...
add_action( 'wp_enqueue_scripts', 'plugins-js');
add_action( 'wp_enqueue_scripts', 'main-js');
